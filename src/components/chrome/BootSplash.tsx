  ...
  return (
    ...
    >
      <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        {/* wordmark */}
        <div style={{ textAlign: "center", marginTop: 44, animation: "bootword 0.7s ease 0.1s both" }}>
          <div style={{ fontSize: 46, fontWeight: 700, letterSpacing: 1, lineHeight: 1 }}>
            Ter<span style={{ color: "var(--text-dim)" }}>CTL</span>
          </div>
          <div style={{ fontSize: 14, color: "var(--text-muted)", marginTop: 13, letterSpacing: 0.2 }}>
        ...
        >
          <span style={{ color: "var(--green)", animation: "bootBreathe 1.8s ease-in-out infinite" }}>●</span>
          <span style={{ color: "var(--text-dim)" }}>establishing secure channel</span>
          <span
            style={{
