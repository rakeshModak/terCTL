...
export function UpdateBanner() {
  ...
  if (!update || !((status === 'available' && !dismissed) || downloading))
    return null;

  return (
    <div
      className="fixed bottom-5 left-1/2 z-[120] flex w-[380px] max-w-[92vw] -translate-x-1/2 animate-[rise_0.2s_ease_both] flex-col gap-[12px] rounded-[13px] border border-[var(--border-2)] bg-[linear-gradient(160deg,var(--bg-card-top),var(--bg-card))] p-[14px]"
    ...
    >
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[11.5px] text-[var(--text-muted)]">
            {downloading
              ...
              : 'A new version of TerCTL is ready to install.'}
          </div>
        </div>
        {!downloading && (
          <button
      ...
      {downloading ? (
        <div className="bg-foreground/[0.06] h-[4px] w-full overflow-hidden rounded-full">
          <div
