            ...
            return (
              ...
              >
                ...
                {active && !isWorkspace && tabs.length > 1 && (
                  <button
                    type="button"
                    className="text-muted-foreground hover:text-primary flex shrink-0 items-center"
                ...
                <button
                  type="button"
                  className="text-muted-foreground hover:text-destructive flex shrink-0 items-center"
                  title="Close tab"
                  onClick={(e) => {
                    e.stopPropagation();
                    closeTab(tab.id);
