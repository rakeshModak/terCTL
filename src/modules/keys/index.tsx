    ...
    <div className="flex-1 overflow-y-auto bg-[var(--bg)]">
      <div className="mx-auto max-w-[920px] px-8 py-[26px]">
        <div className="mb-[22px] flex items-end gap-3">
          <div>
            <h1 className="m-0 text-[26px] font-bold tracking-[-0.3px]">
              Keys &amp; Identity
            </h1>
            <p className="mt-[5px] mb-0 text-[13px] text-[var(--text-muted)]">
              3 keys · agent unlocked · 42 known hosts
            </p>
          </div>
          <div className="flex-1" />
          <span
            className="rounded-lg border px-[11px] py-[5px] text-[11px] whitespace-nowrap text-[var(--amber)]"
            style={{
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg,rgba(61,220,151,0.09),rgba(61,220,151,0.02))',
        ...
        >
          ...
          <div className="flex-1">
            ...
            <div className="mt-[2px] text-xs text-[var(--text-muted)]">
              Passphrases stored in system keychain · auto-locks after 15 min
              idle
            </div>
          </div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-[9px]">
                    ...
                    <span
                      className="rounded-md px-2 py-[2px] text-[10px] font-semibold tracking-[0.4px]"
                  ...
                  <div
                    className="mt-1 text-[11.5px] text-[var(--text-faint)]"
                    style={{ fontFamily: 'var(--font-mono)' }}
                  >
                    {k.fp} · {k.comment}
                  </div>
                ...
                <div className="text-right">
                  <div className="mb-[6px] text-[11px] text-[var(--text-faint)]">
                    added {k.added}
                  </div>
                  <span
                    className="inline-flex items-center gap-[6px] text-[11.5px]"
